...
public:
	...
	virtual inline Screen&												GetScreen()														{ return *m_screen; }
	inline void															SetScreen(Screen& _screen)										{ m_screen = &_screen; }

	virtual inline Events&												GetEvents() { return *m_events; }
	inline void															SetEvents(Events& _events) { m_events = &_events; }
private:
