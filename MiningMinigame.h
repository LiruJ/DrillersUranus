...
namespace Minigames
{
	...
	public:
		...
		void Generate(Point, unsigned char);
	...
	private:
		...
		static const unsigned char	c_wallWidth = 120;

		/// <summary> The height of the wall in tiles. </summary>
		static const unsigned char	c_wallHeight = 60;

		const unsigned short		c_maxTimer = 1000;
		...
		const unsigned short		c_maxAttempts = 20000;

		/// <summary> The max amount of allowed tiles. </summary>
		const unsigned char			c_maxHeight = 13;

		/// <summary> The layer to which the minigame resets. </summary>
		const unsigned char			c_minimumHeight = 3;

		/// <summary> The tile data. </summary>
		unsigned char				m_wallData[c_wallWidth][c_wallHeight];
		...
		void generateBump(unsigned char);
